export const MEMBERS = [
  { name: "Tian Wen", photo: "/pic/Tian%20Wen.png", role: "Hardware — Mechanical", line: "Designs the structure everything else bolts to, from concept to fabricated part.", chips: ["CAD & tolerancing", "Fabrication", "Mechanism design"],
  ...
  { name: "Jovyan", photo: "/pic/Jovyan.jpeg", role: "AI / Software Engineer", line: "Turns models and logic into software that keeps running on the floor.", chips: ["Backend services", "Model deployment", "Data pipelines"],
  ...
  { name: "Vincent Santosa", photo: "/pic/Vincent%20Santosa.jpg", role: "Hardware — Electronics", line: "Power, sensing and control boards, from schematic through bring-up.", chips: ["Schematic & PCB", "Sensors", "Bring-up & test"],
  ...
  { name: "Davina Nadine", photo: "/pic/Davina%20Nadine.jpeg", role: "Business Analyst / Systems Engineer", line: "Translates a plant problem into requirements the team can build against.", chips: ["Requirements", "Process mapping", "Cost & ROI"],
  ...
  { name: "Cliffton Owen", photo: "/pic/Cliffton.jpg", role: "AI / ML / Software Engineer", line: "Builds the perception and decision models, and the evidence that they work.", chips: ["Computer vision", "Model training", "Evaluation"],
  ...
  { name: "Brian Wong", photo: "/pic/Brian.jpg", role: "Project Manager, UI/UX", line: "Keeps the schedule honest and the operator interface usable.", chips: ["Delivery", "Interface design", "Stakeholder comms"],
  ...
  { name: "Wen Xuan", photo: "/pic/WenXuan.jpg", role: "Hardware — System Integration", line: "Makes the subsystems behave as one machine, safely.", chips: ["Integration", "Commissioning", "Safety & interlocks"],
